...
def main():
    print("Bawimy się  imię  :):):)  ")
    print("imię 'Kleopatra' konczy działanie\n\n")
    imie_kursanta = ""
    while imie_kursanta.lower() != "kleopatra":
        imie_kursanta = przywiatnie_pythona()
        if kobieta_czy_mezczyzna(imie_kursanta) == 'K':
            print(f"Miło cię powitać {odmiana_zenskiego_imienia(imie_kursanta)} :)")
        else:
        ...
        try:
            ...
            print("\n\nnic z tego :):) - pamietasz Kleopatra !!\n\n")
